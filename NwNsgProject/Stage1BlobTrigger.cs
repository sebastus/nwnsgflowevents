...
namespace NwNsgProject
{
    public static class Stage1BlobTrigger
    {
        ...
        public static void Run(
            [BlobTrigger("insights-logs-networksecuritygroupflowevent/resourceId=/SUBSCRIPTIONS/{subId}/RESOURCEGROUPS/{resourceGroup}/PROVIDERS/MICROSOFT.NETWORK/NETWORKSECURITYGROUPS/{nsgName}/y={blobYear}/m={blobMonth}/d={blobDay}/h={blobHour}/m={blobMinute}/macAddress={mac}/PT1H.json", Connection = "tftest")]CloudBlockBlob myBlob,
